			...
			<form action="process_add_cheering.jsp" method="post">
				<div class="col-sm-10" style="background: #ffffff">
					...
					<div style="margin-left: 30px">
						...
						<input type="text" id="title" name="title" style="width: 30%" required="required">
					</div>
					<br>
					<hr>
					<br>
					...
					<div class="text-right">
						<input type="submit"
							style="width: 150px; background-color: #6699FF; border: none; color: #fff; padding: 15px 0; text-align: center; text-decoration: none; display: inline-block; font-size: 20px; margin: 4px; cursor: pointer; border-radius: 10px; margin-right: 100px" required="required">
					</div>
					<br>
				</div>
			</form>
