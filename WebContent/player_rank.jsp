...
<head>
  ...
  body{
	...
	.jumbotron {
	 	margin-top:10px;
        background: url("https://www.itl.cat/pngfile/big/25-259538_gary-cahill-chelsea-premier-league-chelsea-team-wallpaper.jpg");
  ...
  <div class="row content">
    <div class="col-sm-2 sidenav">
      ...
      <ul class="nav nav-pills nav-stacked">
        <li class="active"><a href="player_rank.jsp">득점 순위</a></li>
    ...
    <tbody>
    	...
    	%>
    			<tr class="active-row">
		            ...
		            <td><%=player.getShots() %></td>
		            <td><%=player.getShotsInTarget() %></td>
